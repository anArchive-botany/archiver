...
public class SpecimenTabella extends OggettoPerTabella{
    ...
    private Object eseguiOperazione(byte op, int colonna, Object o ){
        ...
        case 8:
            ...
            else if(op==READ) { return new Boolean(cartellino.getLocked()!=null && cartellino.getLocked().equals("true")); }
            else {              return new Integer(40);}
        case 9:
            ...
            else if(op==READ) { return new Boolean(cartellino.getNewSign()!=null && cartellino.getNewSign().equals("true")); }
            else {              return new Integer(40);}
        case 10:
            ...
            else if(op==READ) { return new Boolean(cartellino.getAdmitLoan()!=null && cartellino.getAdmitLoan().equals("true")); }
            else {              return new Integer(40);}            
        case 11:
